...
public interface ActCategoryRepository extends JpaRepository<ActCategories, Integer> {
    ...
    List<ICategoriesReport> getTimeReport(@Param("ProjectID") String projectID, @Param("email") String email, @Param("min_date") String minDate, @Param("max_date") String maxDate);
}