...
public interface ActivityRepository extends JpaRepository<Activity, Integer>, PagingAndSortingRepository<Activity, Integer> {
    ...
    List<IActivitiesReportByUserAndDay> getActivitiesPerDay(@Param("email") String email,
    ...
    List<IActivitiesReportByUser> getActivitiesReport(@Param("ProjectID") String projectID, @Param("email") String email,
                                                      @Param("min_date") String minDate, @Param("max_date") String maxDate);
    ...
    @Query(value =
            "select a.email, \n" +
                    ...
                    " order by date_trunc('day', captureddate) asc, 1 asc;", nativeQuery = true)
    List<ITimeReportByUser> getTimeReport(@Param("ProjectID") String projectID, @Param("email") String email,
                                          @Param("min_date") String minDate, @Param("max_date") String maxDate);
